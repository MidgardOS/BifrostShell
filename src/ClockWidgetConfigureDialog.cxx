...
ClockWidgetConfigureDialog::ClockWidgetConfigureDialog(QWidget *parent, const QVector<QByteArray> &timeZoneIds) : QDialog(parent) {
    ...
    for (const QByteArray &zone : zones) {
        ...
        if (! matchingLocales.isEmpty()) {
            QString flag = QStandardPaths::locate(
