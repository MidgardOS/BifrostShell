...
const QDBusArgument &operator>>(const QDBusArgument &argument, KDbusImageStruct &pixmap) {
    ...
    if (argument.currentType() == QDBusArgument::StructureType) {
        ...
        if (_width && _height && !data.isEmpty() ) {
            ...
            pixmap = QPixmap::fromImage(QImage(reinterpret_cast<const uchar *>(data.constData()), _width, _height, QImage::Format_ARGB32));
        }
    }
